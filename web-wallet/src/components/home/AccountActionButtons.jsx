  ...
  return (
    <div className="flex gap-3 justify-end items-center">
      ...
      <button
        ...
        className="inline-flex items-center justify-center gap-2 rounded-full text-sm font-semibold tracking-wide py-2 px-4 border transition-all duration-200 cursor-pointer border-[rgba(255,107,26,0.3)] text-foreground hover:border-accent hover:-translate-y-0.5 flex-shrink-0"
      ...
      <button
        ...
        className="inline-flex items-center justify-center gap-2 rounded-full text-sm font-semibold tracking-wide py-2 px-4 border transition-all duration-200 cursor-pointer border-red-500/30 text-red-400 hover:border-red-500 hover:bg-red-500/10 hover:-translate-y-0.5"
