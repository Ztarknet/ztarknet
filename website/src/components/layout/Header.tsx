  ...
  return (
    <header className="relative">
      ...
      <nav className="lg:hidden flex items-center justify-between px-3 py-2.5 fixed top-3 left-0 right-0 z-[200] bg-black border border-[rgba(255,107,26,0.2)] rounded-full mx-8 backdrop-blur-xl">
        <Link href="#top" className="inline-flex items-center gap-3 font-bold tracking-widest uppercase text-sm">
          <Image
            src="/ztarknet-logo.png"
            alt="Ztarknet logo"
            width={32}
        ...
        <div className="flex items-center gap-2">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="w-full bg-black border-l-[rgba(255,107,26,0.2)] backdrop-blur-xl pt-[72px]">
            ...
            <div className="flex flex-col gap-6 mt-8">
              ...
              <Button variant="primary" asChild className="w-full">
                <Link href="https://github.com/AbdelStark/ztarknet" target="_blank" rel="noreferrer" onClick={handleLinkClick}>
                  GitHub
                </Link>
              </Button>
            </div>
