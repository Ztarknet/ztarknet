...
import { Minimize2, ShieldCheck, Code } from "lucide-react";
          ...
          <article className="group reveal-on-scroll relative h-full rounded-2xl border border-[rgba(255,137,70,0.25)] bg-[rgba(8,8,12,0.8)] p-2 md:rounded-3xl md:p-3 transition-all duration-300">
            ...
            <div className="relative flex h-full flex-col gap-3 overflow-hidden rounded-xl bg-gradient-to-br from-[rgba(12,12,18,0.9)] to-[rgba(6,6,9,0.8)] p-8 shadow-[0_18px_36px_rgba(0,0,0,0.35)] transition-all duration-300 group-hover:shadow-[0_18px_36px_rgba(255,137,70,0.15)]">
              ...
              <div className="relative flex flex-1 flex-col gap-3 z-10">
                ...
                <h3 className="text-xl font-bold mb-3 text-white transition-colors duration-300 group-hover:text-[rgba(255,137,70,0.95)]">Keep Zcash minimal</h3>
                <p className="text-[rgba(255,255,255,0.7)] leading-relaxed">
                  Push general-purpose computation to a Cairo VM on L2. Zcash verifies
                  the proof via TZE and keeps consensus surface area tight.
                </p>
              </div>
            </div>
          </article>
          ...
          <article className="group reveal-on-scroll relative h-full rounded-2xl border border-[rgba(255,137,70,0.25)] bg-[rgba(8,8,12,0.8)] p-2 md:rounded-3xl md:p-3 transition-all duration-300">
            ...
            <div className="relative flex h-full flex-col gap-3 overflow-hidden rounded-xl bg-gradient-to-br from-[rgba(12,12,18,0.9)] to-[rgba(6,6,9,0.8)] p-8 shadow-[0_18px_36px_rgba(0,0,0,0.35)] transition-all duration-300 group-hover:shadow-[0_18px_36px_rgba(255,137,70,0.15)]">
              ...
              <div className="relative flex flex-1 flex-col gap-3 z-10">
                ...
                <h3 className="text-xl font-bold mb-3 text-white transition-colors duration-300 group-hover:text-[rgba(255,137,70,0.95)]">Proof-first integration</h3>
                <p className="text-[rgba(255,255,255,0.7)] leading-relaxed">
                  The draft ZIP introduces a Circle STARK verifier as a new TZE type.
                  Full nodes validate proofs natively—no bespoke scripting, no hand-wavy
                  trust assumptions.
                </p>
              </div>
            </div>
          ...
          <article className="group reveal-on-scroll relative h-full rounded-2xl border border-[rgba(255,137,70,0.25)] bg-[rgba(8,8,12,0.8)] p-2 md:rounded-3xl md:p-3 transition-all duration-300">
            ...
            <div className="relative flex h-full flex-col gap-3 overflow-hidden rounded-xl bg-gradient-to-br from-[rgba(12,12,18,0.9)] to-[rgba(6,6,9,0.8)] p-8 shadow-[0_18px_36px_rgba(0,0,0,0.35)] transition-all duration-300 group-hover:shadow-[0_18px_36px_rgba(255,137,70,0.15)]">
              ...
              <div className="relative flex flex-1 flex-col gap-3 z-10">
                ...
                <h3 className="text-xl font-bold mb-3 text-white transition-colors duration-300 group-hover:text-[rgba(255,137,70,0.95)]">Programmable freedom</h3>
                <p className="text-[rgba(255,255,255,0.7)] leading-relaxed">
                  Starknet tooling, account abstraction, and Cairo contracts become
                  available to Zcash users while L1 privacy stays uncompromised.
                </p>
              </div>
            </div>
          </article>
