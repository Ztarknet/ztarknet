<div align="center">
  <img src="apps/website/public/logo.svg" alt="Ztarknet logo" width="320" />
  <h1>Ztarknet 🛡️🐺 </h1>
...
**Why Zcash?** Zcash already offers a strong base-layer privacy. Ztarknet explores **programmability and scale** via an L2—with validity proofs checked natively on Zcash using the TZE framework ([ZIP-222](https://zips.z.cash/zip-0222)) and the associated digest changes (ZIP-245/244).
...
> TBD: mostly raw thoughts at the moment, and far from a fully fleshed design
