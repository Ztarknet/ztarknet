...
export function BlockCard({ block, isLoading = false }) {
  if (isLoading) {
    return (
      <div className="py-3.5 px-5 bg-card-bg border border-[rgba(255,137,70,0.2)] rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.3)] backdrop-blur-[16px] transition-all duration-300 opacity-100 grid md:grid-cols-[auto_minmax(200px,1fr)_repeat(3,auto)] grid-cols-1 gap-5 md:gap-5 gap-3 items-center no-underline cursor-pointer skeleton">
  ...
  return (
    <a
      ...
      className={`py-3.5 px-5 bg-card-bg border border-[rgba(255,137,70,0.2)] rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.3)] backdrop-blur-[16px] transition-all duration-300 opacity-100 grid md:grid-cols-[auto_minmax(200px,1fr)_repeat(3,auto)] grid-cols-1 gap-5 md:gap-5 gap-3 items-center no-underline cursor-pointer hover:border-[rgba(255,137,70,0.5)] hover:translate-x-1 ${
