// TZE parsing helpers
export function parseTZEData(hexString, isInput = false) {
...
export function parseCompactSize(hexString, offset) {
...
export function getTZETypeName(tzeId) {
  switch (tzeId) {
    case 0: return 'demo';
...
export function getTZEModeName(tzeId, tzeMode) {
...
export function parseStarkVerifyPrecondition(payload) {
...
export function parseStarkVerifyWitness(payload) {
