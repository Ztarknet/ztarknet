...
export function Hero() {
  ...
  return (
    <section
      className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 max-w-container mx-auto mt-28 lg:mt-32 pb-[120px] relative px-8 md:px-0 lg:items-center"
      id="top"
    >
      ...
      <div className="flex flex-col gap-6 justify-center">
        ...
        <p className="text-lg leading-relaxed text-foreground">
          Ztarknet explores a Starknet-inspired rollup that anchors to Zcash L1 via a Transparent
          Zcash Extension (TZE) verifier. Programmable, privacy-native, and battle-ready for
          zero-knowledge maximalists.
        </p>
          ...
          <div className="relative flex h-full flex-col gap-3 overflow-hidden rounded-xl bg-gradient-to-br from-[rgb(12,12,18)] to-[rgb(6,6,9)] p-6 shadow-[0_18px_36px_rgba(0,0,0,0.35)] transition-all duration-300 group-hover:shadow-[0_18px_36px_rgba(255,137,70,0.15)]">
            ...
            <div className="relative flex flex-1 flex-col gap-3 z-10">
              ...
              <p className="text-[rgba(255,255,255,0.7)] leading-relaxed">
                Each state root lives in a TZE output. Spend prev anchor, prove the transition, mint
                the next root. Minimal surface, maximum verifiability.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative flex h-full flex-col gap-3 overflow-hidden rounded-xl bg-gradient-to-br from-[rgb(12,12,18)] to-[rgb(6,6,9)] p-6 shadow-[0_18px_36px_rgba(0,0,0,0.35)] transition-all duration-300 group-hover:shadow-[0_18px_36px_rgba(255,137,70,0.15)]">
            ...
            <div className="relative flex flex-1 flex-col gap-3 z-10">
              ...
              <p className="text-[rgba(255,255,255,0.7)] leading-relaxed">
                Zcash shields what matters. Ztarknet adds programmable headroom without touching
        ...
        >
          ...
          <div className="relative flex h-full flex-col gap-3 overflow-hidden rounded-xl bg-gradient-to-br from-[rgb(12,12,18)] to-[rgb(6,6,9)] p-6 shadow-[0_18px_36px_rgba(0,0,0,0.35)] transition-all duration-300 group-hover:shadow-[0_18px_36px_rgba(255,137,70,0.15)]">
            ...
            <div className="relative flex flex-1 flex-col gap-3 z-10">
              ...
              <p className="text-[rgba(255,255,255,0.7)] leading-relaxed">
                Zebra fork, Madara, and Stwo/Cairo glue together an end-to-end Rust pipeline for
                experimentation.
              </p>
            </div>
          </div>
