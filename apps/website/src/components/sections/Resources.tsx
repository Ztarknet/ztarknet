...
export function Resources() {
  ...
  return (
    <section className="py-[120px] px-8 bg-[rgba(6,6,8,0.75)]" id="resources">
        ...
        <div className="flex flex-wrap gap-[18px]">
          {resources.map((resource, index) => (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="reveal-on-scroll px-[18px] py-[14px] rounded-full border border-[rgba(255,137,70,0.4)] bg-[rgba(12,12,16,0.8)] font-mono text-xs tracking-[0.12em] uppercase text-[rgba(255,137,70,0.76)] transition-all duration-[250ms] hover:-translate-y-1 hover:border-[var(--accent)]"
