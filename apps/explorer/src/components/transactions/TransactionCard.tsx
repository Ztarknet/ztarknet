    ...
    return (
      ...
      >
        ...
        <div className="md:hidden flex flex-col gap-3">
          <span className="text-[0.65rem] font-mono uppercase tracking-wider font-bold whitespace-nowrap min-w-[80px] text-center inline-block py-1 px-2.5 rounded bg-accent text-background skeleton-text">
            ---
          </span>
